...
import type { ChapterMeta, FieldbookEntry } from './types';

const moonChapter: ChapterMeta = {
  id: 'moon',
  title: 'The Moon',
  kind: 'sky',
  season: 'always',
...
const orionChapter: ChapterMeta = {
  id: 'orion',
  title: 'Orion',
  kind: 'sky',
  season: 'winter',
...
function entry(patch: Partial<FieldbookEntry>): FieldbookEntry {
  return {
